...
class GymAccessrightController extends AppController
{
	public function accessRight()
    {
		...
		{			
			...
			//---------NEW MENU LINK START------------------ 
			$access_right['staff_member'] = array('menu_icone'=>'staff-member.png' ,'menu_title'=>'Coach',	
			...
			'page_link'=>$site_path.'/coach-members/coach-list',
			'controller'=>"CoachMembers");
			//---------NEW MENU LINK START------------------ 
			...
			//---------NEW MENU LINK START------------------ 
			$access_right['reservation'] =array('menu_icone'=>'reservation.png' ,'menu_title'=>'Reservation',
