          ...
          <!-- <li class="header">MAIN NAVIGATION</li> -->		 
			...
			<!-- li class="treeview <?php echo ($this->request->controller == "Membership") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("membership","membership_list");?>">
                <i class="fa fa-users"></i> <span><?php echo __('Regular Rate');?></span>  
              </a>			   
			</li -->
			<li class="treeview <?php echo ($this->request->controller == "Membership" || $this->request->controller == "Package" )  ? "active" : "";?>"> <!-- $this->request->controller == "Package"  -->
              <a href="<?php echo $this->Gym->createurl("Membership","membershipList");?>">
                <i class="fa fa-users"></i> <span><?php echo __('Membership & Package');?></span></i><i class="fa fa-angle-left <?php echo $pull;?>"></i>
              </a>
			   <ul class="treeview-menu">
					<li class="treeview <?php echo ($this->request->controller == "Membership") ? "active" : "";?>">
									<a href="<?php echo $this->Gym->createurl("membership","membership_list");?>">
										<i class="fa fa-circle-o"></i> <span><?php echo __('Membership');?></span>  
									</a>			   
					</li>
					
					<li class="treeview <?php echo ($this->request->controller == "Package") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("package","package_list");?>">
							<i class="fa fa-circle-o"></i><span><?php echo __('Package Type');?></span>
						</a>
					</li>
			...
			<!-- dating group-->
			<li class="treeview <?php echo ($this->request->controller == "GymGroup" || $this->request->controller == "ClassSchedule" ) ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymGroup","GroupList");?>">
                <i class="fa fa-calendar"></i> <span><?php echo __('Group and Class');?></span></i><i class="fa fa-angle-left <?php echo $pull;?>"></i>
              </a>
			   <ul class="treeview-menu">
			<li class="treeview <?php echo ($this->request->controller == "GymGroup") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymGroup","GroupList");?>">
                <i class="fa fa-circle-o"></i> <span><?php echo __('Group');?></span> 
              </a>
			</li>			
			<li class="treeview <?php echo ($this->request->controller == "ClassSchedule" || $this->request->controller == "ClassSchedule") ? "active" : "";?>">
			...
			<li class="treeview <?php echo ($this->request->controller == "GymMember" || $this->request->controller == "CoachMembers" || $this->request->controller == "GymStaff") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymMember","memberList");?>">
                <i class="fa fa-user"></i> <span><?php echo __('User Management');?></span></i><i class="fa fa-angle-left <?php echo $pull;?>"></i>
              </a>
			   <ul class="treeview-menu">
					...
					<li class="<?php echo ($this->request->action == "coachList" || $this->request->action == "addCoach") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("CoachMembers","CoachList");?>">
							<i class="fa fa-circle-o"></i><span><?php echo __('Coach');?></span></i>
						</a>
					</li>
					<li class="<?php echo ($this->request->action == "staffList" || $this->request->action == "addStaff") ? "active" : "";?>">
					  <a href="<?php echo $this->Gym->createurl("GymStaff","staffList");?>">
						<i class="fa fa-circle-o"></i> <span><?php echo __("Staff");?></span>
					  </a>
					</li>
              </ul>			  
			</li>
			...
			<li class="treeview <?php echo ($this->request->controller == "gymEmailSetting") ? "active" : "";?>">
