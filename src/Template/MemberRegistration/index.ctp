...
//Height Weight	
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="email">'. __("Height (cm)").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-2">';
			echo $this->Form->input("",["label"=>false,"name"=>"height_data","class"=>"form-control validate[required]","value"=>(($edit)?$data['height_data']:'')]);
			echo "</div>";	
//Weight
			echo '<label class="control-label col-md-2" for="email">'. __("Weight (kg)").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-2">';
			echo $this->Form->input("",["label"=>false,"name"=>"weight_data","class"=>"form-control validate[required]","value"=>(($edit)?$data['weight_data']:'')]);
			echo "</div>";	
			echo "</div>";	
//Date of Birth
			echo "<div class='form-group'>";	
...
/**			echo "<div class='form-group'>";	
	...
	*/	
	//Health History
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="email">'. __("Health Problem/History <br>(if any)").'</label>';
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"health_history","class"=>"form-control","value"=>(($edit)?$data['health_history']:'')]);
			echo "</div>";	
			echo "</div>";		
//Select Membership	
...
//Class			
			...
			echo $this->Form->button(__("Register"),['class'=>"col-md-offset-2 btn btn-flat btn-primary","name"=>"add_member"]);
			echo "</div>";
			echo '<div class="col-md-5 col-sm-6 col-xs-6 pull-right">';
			echo "<a href='".$this->request->base ."/Users/' class='btn btn-primary'>".__('Go Back')."</a>";
			echo '</div>';
			echo '</div>';
			echo $this->Form->end();
		?>
