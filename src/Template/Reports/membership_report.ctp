<script>
function membershipReportPrint() {
	document.title = "Membership Report";
  window.print();
		...
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				...
				<a class="btn btn-flat btn-custom" onclick="membershipReportPrint()"><i class="fa fa-print"></i> <?php echo __("Print");?></a>
			</ol>
			</section>
		</div>
		<hr>
