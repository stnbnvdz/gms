...
<form name="student_form" action="" method="post" class="form-horizontal" id="access_right_form">
		...
		<div class="col-md-2 col-sm-3 col-xs-3"><?php echo __("Coach");?></div>
		<div class="col-md-2 col-sm-3 col-xs-3"> <?php echo __("Staff");?> </div>
		
		</div>
		<div class="row">
			<div class="col-md-2 col-sm-3 col-xs-5 ">
				<span class="menu-label">
					<?php echo __("Coach"); ?>				</span>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-2">
				<div class="checkbox">
					<label>
						<input type="checkbox" disabled <?php echo ($member["report"])?"checked":"";?> value="1" name="member_report" readonly="">	              
					</label>
				</div>
			</div>
			<div class="col-md-2 col-sm-3 col-xs-2">
