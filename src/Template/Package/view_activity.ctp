...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="box-body">
			...
			echo $this->Form->input("package_id",["type"=>"hidden","value"=>$this->request->params['pass'][0]]);
				...
				<?php
					foreach($assigned_activities as $activity)
					{
						...
						echo "<tr>
							...
							<td>{$category}</td>
							<td>{$staff}</td>
							<td><a href='".$this->Gym->createurl('Package','deleteActivity')."/{$activity['id']}' class='btn btn-flat btn-danger'>Delete</a></td>
							</tr>";
					}
				?>
				</tbody>
