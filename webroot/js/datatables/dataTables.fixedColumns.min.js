...
$jscomp.findInternal = function (c, g, e) {
    ...
    for (var q = c.length, l = 0; l < q; l++) {
        var u = c[l];
        if (g.call(e, u, l, c)) return { i: l, v: u };
    }
    return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (c, g, e, q) {
    if (g) {
        e = $jscomp.global;
        c = c.split(".");
...
(function (c) {
    "function" === typeof define && define.amd
        ? define(["jquery", "datatables.net"], function (g) {
              return c(g, window, document);
          })
        : "object" === typeof exports
        ? (module.exports = function (g, e) {
              g || (g = window);
              (e && e.fn.dataTable) || (e = require("datatables.net")(g, e).$);
              return c(e, g, g.document);
          })
    ...
    var l = c.fn.dataTable,
        ...
        p = function (a, b) {
            ...
            if (this instanceof p) {
                ...
                h && (h(p.defaults, p.defaults, !0), h(p.defaults, b));
    ...
    c.extend(p.prototype, {
        ...
        fnGetPosition: function (a) {
            ...
            if (c(a).parents(".DTFC_Cloned").length) {
                if ("tr" === a.nodeName.toLowerCase())
                    return (
                        (a = c(a).index()),
                        b.fnGetPosition(c("tr", this.s.dt.nTBody)[a])
                    );
                var d = c(a).index();
                ...
                return [
                    b.fnGetPosition(c("tr", this.s.dt.nTBody)[a]),
                    d,
                    b.oApi._fnVisibleToColumnIndex(this.s.dt, d),
                ];
            }
        ...
        fnToFixedNode: function (a, b) {
            ...
            b < this.s.iLeftColumns
                ? (d = c(this.dom.clone.left.body).find(
                      "[data-dt-row=" + a + "][data-dt-column=" + b + "]"
                  ))
                : b >= this.s.iRightColumns &&
                  (d = c(this.dom.clone.right.body).find(
                      "[data-dt-row=" + a + "][data-dt-column=" + b + "]"
                  ));
            return d && d.length
                ? d[0]
                : new c.fn.dataTable.Api(this.s.dt).cell(a, b).node();
        },
        _fnConstruct: function (a) {
            ...
            if (
                ...
                c(g).on("resize.DTFC", function () {
                    b._fnGridLayout.call(b);
                });
                var m = !0,
                    k = c(this.s.dt.nTable);
            ...
            c.each(this.s.dt.aoColumns, function (h, f) {
                ...
                if (f.filter(":visible").length) {
                    ...
                    if (0 === a.s.aiOuterWidths.length) {
                        var k = c(a.s.dt.nTable).css("border-left-width");
                        m +=
                    ...
                    a.s.aiOuterWidths.length === a.s.dt.aoColumns.length - 1 &&
                        ((k = c(a.s.dt.nTable).css("border-right-width")),
                        (m +=
                            "string" === typeof k && -1 === k.indexOf("px")
                                ? 1
                                : parseInt(k, 10)));
        ...
        _fnGridSetup: function () {
            ...
            0 < this.s.iLeftColumns &&
                ((this.dom.grid.left.wrapper = d),
                (this.dom.grid.left.head = d.childNodes[0]),
                (this.dom.grid.left.body = d.childNodes[1]),
                (this.dom.grid.left.liner = c("div.DTFC_LeftBodyLiner", b)[0]),
                b.appendChild(d));
            ...
            this.s.dt.nTFoot &&
                ...
                0 < this.s.iLeftColumns &&
                    (this.dom.grid.left.foot = d.childNodes[2]),
                0 < this.s.iRightColumns &&
                    (this.dom.grid.right.foot = h.childNodes[2]));
            this.s.rtl &&
                c("div.DTFC_RightHeadBlocker", b).css({
                    left: -a.bar + "px",
                    right: "",
                });
        },
        _fnGridLayout: function () {
            ...
            var d = this.s.dt.nTable.parentNode.offsetHeight,
                ...
                x = "rtl" === c(this.dom.body).css("direction"),
                w = function (b, d) {
                    f.bar
                        ? a._firefoxScrollError()
                            ? 34 < c(b).height() &&
                              (b.style.width = d + f.bar + "px")
                            : (b.style.width = d + f.bar + "px")
                        : ((b.style.width = d + 20 + "px"),
            ...
            0 < this.s.iLeftColumns &&
                ...
                (h.style.height = "1px"),
                x
                    ? ((h.style.left = ""), (h.style.right = 0))
                    : ((h.style.left = 0), (h.style.right = "")),
                (b.left.body.style.height = d + "px"),
                b.left.foot &&
                    (b.left.foot.style.top = (f.x ? f.bar : 0) + "px"),
                w(b.left.liner, m),
                (b.left.liner.style.height = d + "px"),
                (b.left.liner.style.maxHeight = d + "px"));
            0 < this.s.iRightColumns &&
                ((h = b.right.wrapper),
                (h.style.width = k + "px"),
                (h.style.height = "1px"),
                this.s.rtl
                    ? ((h.style.left = f.y ? f.bar + "px" : 0),
                      (h.style.right = ""))
                    : ((h.style.left = ""),
                      (h.style.right = f.y ? f.bar + "px" : 0)),
                (b.right.body.style.height = d + "px"),
                b.right.foot &&
                    (b.right.foot.style.top = (f.x ? f.bar : 0) + "px"),
                w(b.right.liner, k),
                (b.right.liner.style.height = d + "px"),
                (b.right.liner.style.maxHeight = d + "px"),
        ...
        _fnCopyLayout: function (a, b, d) {
            for (var h = [], f = [], m = [], k = 0, x = a.length; k < x; k++) {
                var w = [];
                w.nTr = c(a[k].nTr).clone(d, !1)[0];
                for (var e = 0, n = this.s.iTableColumns; e < n; e++)
                    if (-1 !== c.inArray(e, b)) {
                        var g = c.inArray(a[k][e].cell, m);
                        -1 === g
                            ? ((g = c(a[k][e].cell).clone(d, !1)[0]),
                              f.push(g),
                              m.push(a[k][e].cell),
                              w.push({ cell: g, unique: a[k][e].unique }))
                            : w.push({ cell: f[g], unique: a[k][e].unique });
                    }
                h.push(w);
            }
            return h;
        ...
        _fnClone: function (a, b, d, h) {
            ...
            if (h) {
                ...
                var l = c(">thead", a.header);
                l.empty();
                var n = 0;
                for (m = g.length; n < m; n++) l[0].appendChild(g[n].nTr);
                ...
                for (m = g.length; n < m; n++) {
                    var t = 0;
                    for (l = g[n].length; t < l; t++)
                        (p[n][t].cell.className = g[n][t].cell.className),
                            c("span.DataTables_sort_icon", p[n][t].cell).each(
                                function () {
                                    this.className = c(
            ...
            if (0 < e.aiDisplay.length) {
                ...
                for (k = 0; k < d.length; k++) {
                    ...
                    l.height = 0;
                    l.width = f.s.aiInnerWidths[v] + "px";
                    m.appendChild(r);
                }
                    ...
                    for (k = 0; k < d.length; k++)
                        (v = d[k]),
                            0 < b.length &&
                                ...
                                r.setAttribute("data-dt-row", a),
                                r.setAttribute("data-dt-column", v),
                                e.appendChild(r));
                    u.appendChild(e);
                });
            } else
            ...
            e.oScroller !== q &&
                ((m = e.oScroller.dom.force),
                b.forcer
                    ? (b.forcer.style.height = m.style.height)
                    : ((b.forcer = m.cloneNode(!0)),
            ...
            if (null !== e.nTFoot) {
                if (h) {
                    ...
                    for (
                        g = this._fnCopyLayout(e.aoFooter, d, !1),
                            b = [],
                            e.oApi._fnDetectHeader(b, c(">tfoot", a.footer)[0]),
                            n = 0,
                            m = g.length;
                        n < m;
                        n++
                    )
                        for (t = 0, l = g[n].length; t < l; t++)
                            b[n][t].cell.className = g[n][t].cell.className;
            ...
            null !== f.s.dt.nTFoot &&
                ((b = e.oApi._fnGetUniqueThs(e, c(">tfoot", a.footer)[0])),
                c(b).each(function (a) {
                    v = d[a];
                    this.style.width = f.s.aiInnerWidths[v] + "px";
                }));
        ...
        _fnEqualiseHeights: function (a, b, d) {
            if (
                ...
                d = 0;
                for (a = b.length; d < a; d++)
                    (b[d].style.height = f[d] + "px"),
                        (e[d].style.height = f[d] + "px");
            }
        },
    ...
    p.version = "3.3.0";
    l.Api.register("fixedColumns()", function () {
        return this;
    });
    l.Api.register("fixedColumns().update()", function () {
        return this.iterator("table", function (a) {
            a._oFixedColumns && a._oFixedColumns.fnUpdate();
        });
    });
    l.Api.register("fixedColumns().relayout()", function () {
        return this.iterator("table", function (a) {
            a._oFixedColumns && a._oFixedColumns.fnRedrawLayout();
        });
    });
    l.Api.register("rows().recalcHeight()", function () {
        return this.iterator("row", function (a, b) {
            a._oFixedColumns &&
                a._oFixedColumns.fnRecalculateHeight(this.row(b).node());
        });
    });
    l.Api.register("fixedColumns().rowIndex()", function (a) {
        a = c(a);
        return a.parents(".DTFC_Cloned").length
            ? this.rows({ page: "current" }).indexes()[a.index()]
            : this.row(a).index();
    });
    l.Api.register("fixedColumns().cellIndex()", function (a) {
        a = c(a);
    ...
    c(e).on("init.dt.fixedColumns", function (a, b) {
        if ("dt" === a.namespace) {
            a = b.oInit.fixedColumns;
            var d = l.defaults.fixedColumns;
